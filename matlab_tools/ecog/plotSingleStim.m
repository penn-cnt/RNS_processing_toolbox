function plotSingleStim(Channel,StimNumber, StimStartIndex, StimEndIndex, AllData, AllTime, NumStims, varargin )
%
%plotSingleStim plots the stimulation poststimulation and prestimulation
...
%Parse inputs
parse(p, Channel, StimNumber, StimStartIndex, StimEndIndex, AllData, AllTime, varargin{:})
